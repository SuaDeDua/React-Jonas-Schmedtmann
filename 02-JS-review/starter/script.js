...
const updateBook = {
  ...book,
  // Add a new property (add thêm tính chất mới)
  moviePublishingDate: "2001-02-07",

  // Overwriting an existing property (sửa lại tính chất đã có sẵn)
  pages: 2707,
};
updateBook;
...
const summary = `${title}, a ${
  updateBook.pages
}-pages long book, was written by ${author} and published in ${getYear(
  publicationDate
)}. The book has ${hasMovieAdaptation ? "" : "not"} been adapted as a movie`;
summary;

const pagesRanges =
  updateBook.pages > 1000
    ? "over a thousand pages"
    : "less than a thousand pages";
pagesRanges;
console.log(`the book has ${pagesRanges}`);
